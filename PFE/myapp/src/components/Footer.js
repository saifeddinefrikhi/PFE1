          ...
          <div className="row gy-4 gy-lg-0 justify-content-xl-between">
            ...
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                ...
                <p className="mb-1">
                  <a className="link-secondary text-decoration-none" href="tel:+15057922430">+216 00000000</a>
                </p>
                <p className="mb-0">
                  <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">abcd@email.com</a>
                </p>
              </div>
            </div>
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
